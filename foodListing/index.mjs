    ...
    try
        {
            ...
            // Create new listings
            await listingsCollection.insertOne({...payload})
            ...
            {   
                ...
                const studentRecord = await studentCollection.findOne({oauthCode: payload.oauthCode})
